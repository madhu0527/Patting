...
public class MaterialProgressBar extends ProgressBar {
    ...
    private static final String TAG = me.zhanghai.android.materialprogressbar.MaterialProgressBar.class.getSimpleName();
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, me.zhanghai.android.materialprogressbar.R.styleable.MaterialProgressBar,
                defStyleAttr, defStyleRes);
        mProgressStyle = a.getInt(me.zhanghai.android.materialprogressbar.R.styleable.MaterialProgressBar_mpb_progressStyle,
                PROGRESS_STYLE_CIRCULAR);
        boolean setBothDrawables = a.getBoolean(
                me.zhanghai.android.materialprogressbar.R.styleable.MaterialProgressBar_mpb_setBothDrawables, false);
        boolean useIntrinsicPadding = a.getBoolean(
                me.zhanghai.android.materialprogressbar.R.styleable.MaterialProgressBar_mpb_useIntrinsicPadding, true);
        boolean showTrack = a.getBoolean(me.zhanghai.android.materialprogressbar.R.styleable.MaterialProgressBar_mpb_showTrack,
                mProgressStyle == PROGRESS_STYLE_HORIZONTAL);
        if (a.hasValue(me.zhanghai.android.materialprogressbar.R.styleable.MaterialProgressBar_android_tint)) {
            mProgressTint.mTintList = a.getColorStateList(
                    me.zhanghai.android.materialprogressbar.R.styleable.MaterialProgressBar_android_tint);
            mProgressTint.mHasTintList = true;
        }
        if (a.hasValue(me.zhanghai.android.materialprogressbar.R.styleable.MaterialProgressBar_mpb_tintMode)) {
            mProgressTint.mTintMode = DrawableCompat.parseTintMode(a.getInt(
                    me.zhanghai.android.materialprogressbar.R.styleable.MaterialProgressBar_mpb_tintMode, -1), null);
